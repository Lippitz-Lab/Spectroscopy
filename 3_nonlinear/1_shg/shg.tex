\renewcommand{\lastmod}{June 13, 2024}
...
\begin{itemize}
\item The data set contains the electric field at the surface of two gold nanostructures for two different laser polarization directions at the same laser power (see Fig. \ref{fig:7_combined}). Compare the (relative)  efficiency of second harmonic generation for these four cases. My solution is \pluto{task_shg}.
...
\begin{figure}
  \inputtikz{\currfiledir combined}
  \caption{Vectors of electric field (left) and induced nonlinear polarization (right) at the surface of plasmonic nanostructures. The red arrows depict the sum of all vectors. \label{fig:7_combined}}
\end{figure}
...
For second harmonic generation, a laser beam of short pulses (about 100 fs) is focused on the sample and the generated light is detected in transmission or reflection at half the wavelength. Experiments on single nanostructures are possible using a microscope objective.
...
\inputtikz{\currfiledir phasematch}
...
A nanostructure is the size of the wavelength of light or smaller. Second order nonlinear polarization can be generated at all surface elements. However, in the optical far field, the contributions of all surface elements interfere with each other. This is where the symmetry of the nanostructure enters, while the symmetry of the material is broken by the surface.

If the nanostructure is centrosymmetric (Fig. \ref{fig:7_combined} top), we find for each surface element an identical but mirrored element with opposite direction of the surface normal. Since the direction of the surface normal is in the direction of the nonlinear polarization and thus in the direction of the generated second harmonic field, the contributions of the opposing surface elements cancel out in the optical far field. This breaks down when the size of the structure is no longer small. Then the field emitted at one surface element can acquire a phase difference relative to the field generated at the opposite surface, so that the interference is no longer fully destructive.

If the nanostructure is not centrosymmetric (Fig. \ref{fig:7_combined} bottom), the fundamental field at two opposing surface elements will not be the same. Then the nonlinear polarization is different and the two partial fields do not cancel. Second harmonic generation at the nanostructure is thus a sensitive measure of the symmetry of the particle. In reality, nominally symmetric structures such as spheres are never ideally symmetric. Small protrusions and facets break the symmetry. Gold 'spheres' produce a stronger second harmonic signal than third harmonic, even though the latter is symmetric (but a higher order of nonlinearity and therefore weaker).
