...
\begin{itemize}
\item The data contains absorption spectra of the molecule TDBC in solution at different concentrations. Determine the number of chromophores that contribute to the delocalized state (Data by Tobias Kroh, Bayreuth).  My solution is \pluto{task_TDBC}.
