...
# ╔═╡ 4d33965b-e62b-4042-964d-6ee86fc8db3a
using PGFPlotsX
...
begin
	plot()
	for id in [3,4]
		plot!(df[id].Wavelength_nm_, df[id].Abs2)
	end
	plot!(xlims = (460,620), ylims=(0, 1.2e4))
end

# ╔═╡ a97b5fcb-edf8-4809-8a2c-bc03e3811627
let
