...
# ╔═╡ 52772b0f-2c2c-4c6e-8528-3fd8a814ddd5
md"""
## InGaAs quantum dots: dipole moment from lifetime
"""

# ╔═╡ e2465d34-3c42-4a89-b872-9a1fc94eeee5
md"""
On page 4 of Borri et al. (2001) is says 'From the measured 1-ns exciton radiative lifetime and with 3.5 refractive index we calculate $\mu=34$ Debye.' with a reference to Andreani at al. (1999). There we find their equation (4)
```math
\gamma = \frac{4}{3} \, \frac{n_r}{4 \pi \epsilon_0} 
\, \frac{d^2 \omega^3}{\hbar c^3}
```
With our variables, this is eq. 1.30
```math
A_{21} = \frac{4}{3} \, \frac{n_r^3}{4 \pi \, \epsilon \epsilon_0} 
\, \frac{|\mu_{21}|^2 \omega^3}{\hbar c_0^3}
```
where we applied the 'in medium' rules: a) all $\epsilon_0$ get an $\epsilon$ and b) all $c$ are interpreted as $c_0 /n$
"""

# ╔═╡ ff921a74-744d-4275-9dbe-2615b8a1de36
md"""
Lets put in some numbers
"""

# ╔═╡ b06544b1-2a06-4bc8-bd79-8fffba4ddd2a
A_21 = 1/ 1u"ns";
...
# ╔═╡ f19f05d8-e4e4-4010-99d1-ad8826d6ed76
μ_21 = sqrt(A_21 * ħ * c_0^3 * 3 * π  * ε_0 / ( n_ingaas * ω^3)) |> u"D"

# ╔═╡ bc88557c-af93-4f86-a346-60066d2efe27
md"""
So we agree with Borri et al.
"""
