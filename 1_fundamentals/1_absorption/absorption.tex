...
\begin{itemize}
\item On the last page of \cite{Borri:2002p139}, the authors write 'From the measured 1-ns exciton radiative lifetime and with 3.5 refractive index we calculate $\mu = 34$~Debye.' Convince yourself that this is true! My solution is \pluto{task_borri.jl}.
...
In case you have doubts about the units of variables and equations, see \pluto{check_units.jl}.
